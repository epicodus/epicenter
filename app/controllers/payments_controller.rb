...
private
  def payment_params
    ...
    params.require(:payment).permit(:amount, :student_id, :payment_method_id, :cohort_id, :linked_payment_id, :offline, :category, :notes, :refund_amount, :refund_date, :refund_notes)
  end
