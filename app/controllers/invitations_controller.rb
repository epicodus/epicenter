...
private
  ...
  def set_flash_for_student
    if resource.errors.empty?
      ...
      flash[:notice] = "An invitation email has been sent to #{student.email} to join #{course.description}. #{view_context.link_to('Wrong course?', course_student_path(course, student))}"
    end
  end
end
