feature 'Creating a credit card' do
  ...
  context 'as a student' do
    ...
    xscenario 'with missing account information', :vcr, js: true do
    ...
    xscenario 'with invalid account number', :vcr, js: true do
    ...
    xscenario 'with a cancelled card', :vcr, js: true do
