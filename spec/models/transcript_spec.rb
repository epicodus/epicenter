describe Transcript do
  ...
  describe '#passing_code_reviews' do
    it 'returns all the code reviews for which the student has met expectations', :vcr do
      passed_code_review = FactoryGirl.create(:code_review, course: student.course)
      ...
      failed_code_review = FactoryGirl.create(:code_review, course: student.course)
      ...
      missed_code_review = FactoryGirl.create(:code_review, course: student.course)
  ...
  describe '#attendance_score' do
    it "calculates a score for the student's attendance record" do
      ...
      student.course.update(class_days: (day_one..day_three).map { |day| day })
