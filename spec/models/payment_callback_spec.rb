describe PaymentCallback do
  ...
  it 'adds doc_number to payment' do
  ...
  it 'adds multiple doc_numbers to payment' do
    payment_callback = PaymentCallback.new({ 'paymentId' => payment.id.to_s, 'docNumber' => '1A' })
  ...
  it 'raises error if payment not found' do
  ...
  it 'raises error if doc_number missing' do
